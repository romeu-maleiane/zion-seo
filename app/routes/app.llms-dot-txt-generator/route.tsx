...
function LlmsDotTxtPage() {
    ...
    return isLoading ? (
        ...
        <Page
            ...
            secondaryActions={<Button disabled={data.featureBlocked} onClick={() => window.open(`https://${data.shopDomain}/llms.txt`, "_blank", "noopener,noreferrer")}>View LLMs.txt</Button>}
